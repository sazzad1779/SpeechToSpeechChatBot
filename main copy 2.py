...
from utils import (load_asr_model, load_vad_model, load_bangla_tts_model, 
                   transcribe_audio, apply_vad, bangla_text_to_speech)
from roylagpt_inference import model_setup
...
def handle_audio(data, session_id):
    try:
        ...
        speech_array = process_audio(data)
        ...
        with model_locks['asr']:
            transcription = transcribe_audio(asr_model, speech_array)
